...
interface Photo {
  ...
  {
    id: 1,
    image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/1931d5d1c17694c6da1c5360d8955aa360679067164f2aca17044fc0b0db554f?placeholderIfAbsent=true&apiKey=3db36c7a47f0421d9f87c365488106cc',
    title: 'Laying cat',
    tags: '#cat #nature',
    status: 'Visible',
  ...
  {
    id: 2,
    image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/044c3c09b4b4108d2480c0aafa363627043ad0df7814c95fd1830be57a8eed1d?placeholderIfAbsent=true&apiKey=3db36c7a47f0421d9f87c365488106cc',
  ...
  {
    id: 3,
    image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/099d10e267291aedff3d6f2a402521bde5258095a16ade67afbf1f38b590c30b?placeholderIfAbsent=true&apiKey=3db36c7a47f0421d9f87c365488106cc',
      ...
      <div className="flex flex-col w-full max-md:max-w-full">
        <div className="flex flex-wrap gap-4 px-4 py-2 w-full border-b border-solid border-b-neutral-300 min-h-[64px] max-md:max-w-full">
          ...
          <div className="flex flex-wrap flex-1 shrink gap-2 justify-center items-center h-full text-sm font-bold tracking-normal leading-5 whitespace-nowrap basis-0 min-w-[240px] text-zinc-800 max-md:max-w-full">
            {['Photos', 'Status', 'Category', 'License', 'Price'].map((header, index) => (
              <div key={index} className="flex flex-1 shrink gap-2 self-stretch my-auto basis-0 min-h-[50px]">
