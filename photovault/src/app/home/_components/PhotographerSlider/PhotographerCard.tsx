...
export default function PhotographerCard({
  ...
  const smBreakpoint = useBreakpoints().sm;
  ...
  return (
    ...
    >
      <picture className='min-w-[40px] w-[60px] aspect-square object-cover rounded-full'>
      ...
      <div className='flex-shrink-0'>
        ...
        {photographer.description && (
          <>
            ...
            <p className='text-xs text-ellipsis max-w-[150px] sm:max-w-[200px] line-clamp-2'>
              {photographer.description}
            </p>
          </>
        )}
